...
const TYPE_USED_BPOINT = "D";

const ReceivedBPoint = () => {
  ...
  const _initData = async () => {
    ...
    // Hide loading
    _.isEmpty(lisTransaction) ? await store.dispatch(setLoading(true)) : null;
    // Init params
            ...
            >
              <Card testID={"itemTransaction_" + index}>
                <Box row between alignCenter>
                  ...
                  <Box row alignCenter>
                    <Text variant="h3" color="success">+{item?.point}</Text>
