...
const UploadImageCurriculum = (props) => {
  ...
  const _uploadImage = (image) => {
    ...
    const checkLink = (link: any) => {
      isFronted
        ? dispatch(setCurriculumFrontImage(link))
        : dispatch(setCurriculumBackImage(link));
    ...
    const optionsAWS3 = {
      ...
      keyPrefix: keyPreFixProfile + `/${taskerId}` + "/curriculum-vitae/",
...
export default UploadImageCurriculum;
