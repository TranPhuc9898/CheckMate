...
import { Box, Container, Card, Text, Image, Button, Alert } from "components";
...
const UpdateImageHouseHold = (props) => {
  ...
  const _uploadImage = (image) => {
    ...
    const checkLink = (link: any) => {
      isFronted
        ? dispatch(setHouseholdFrontImage(link))
        : dispatch(setHouseholdBackImage(link));
    ...
    const optionsAWS3 = {
      ...
      keyPrefix: keyPreFixProfile + `/${taskerId}` + "/household-booklet/",
...
export default UpdateImageHouseHold;
