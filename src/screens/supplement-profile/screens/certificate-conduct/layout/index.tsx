...
const CertificateConduct = () => {
  const [fromCertificate, setFromCertificate] = useState(true);
    ...
    <Container headerShow={true}>
      ...
      >
        ...
        >
          ...
          >
            {_.isEmpty(uploadImage?.certificateFrontImage) ? (
              <Image
          ...
          <Button
            size="md"
            onPress={() => {
              navigateTo("UploadImageCertificate", fromCertificate);
            }}
          >
            <Box
              row
        ...
        >
          ...
          <Box
            ...
            style={styles.boxImage}
          >
            {_.isEmpty(uploadImage?.certificateBackImage) ? (
              <Image
              ...
              >
                <Image
                  source={{
                    uri: `${uploadImage?.certificateBackImage}?${Math.random()}`,
                  }}
                  style={styles.imageStyle}
                  resizeMode="contain"
                />
...
export default CertificateConduct;
