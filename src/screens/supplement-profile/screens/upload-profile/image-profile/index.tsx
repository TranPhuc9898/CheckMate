...
const UploadImageProfile = (props) => {
  ...
  const _uploadImage = (image) => {
    ...
    const checkLink = (link: any) => {
      isFronted
        ? dispatch(setIdentityFrontImage(link))
        : dispatch(setIdentityBackImage(link));
    ...
    const optionsAWS3 = {
      ...
      keyPrefix: keyPreFixProfile + `/${taskerId}` + "/identity-card/",
    ...
    <Container>
      <Card>
        ...
        <Box center>
          {isFronted ? (
            <Image
              source={require("@images/active-account/font-end.png")}
              style={styles.imageFrontOrBack}
              resizeMode="contain"
            />
          ) : (
            <Image
              source={require("@images/active-account/back-end.png")}
              style={styles.imageFrontOrBack}
              resizeMode="contain"
            />
          )}
