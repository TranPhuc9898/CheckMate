...
describe('FILE: thailand/flow-test/service-sofa-cleaning/done-task-sofa-cleaning.spec.js - Tasker done task Viet Nam', () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "TH", financialAccountData: { TH_FMainAccount: 1000, TH_Promotion: 300 } })
    await initData('th/update-user/remove-transaction', { phone: "0834567895" });
  });
