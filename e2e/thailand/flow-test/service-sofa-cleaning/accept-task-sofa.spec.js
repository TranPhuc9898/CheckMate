...
describe("FILE: thailand/flow-test/service-sofa-cleaning/accept-task-sofa-cleaning.spec.js - Tasker accept task SofaCleaning th", () => {
  beforeEach(async () => {
    ...
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "TH", financialAccountData: { TH_FMainAccount: 100000, TH_Promotion: 100000 } })
  });
  ...
  // Thấy công việc và nhận công việc
  it("LINE 131 - Tasker accept task SofaCleaning th", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
  ...
  // conflict time
  it("LINE 154 - Tasker accept task SofaCleaning dont see task conflict time", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
  ...
  // Không đủ tiền
  it("LINE 186 - Tasker accept task SofaCleaning not enough money", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
    ...
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "TH", financialAccountData: { TH_FMainAccount: 10, TH_Promotion: 10 } })
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskSofaCleaning", 1000);
    await tapId("newTask_My TaskSofaCleaning");
    await swipe("scrollTaskDetail", "up");
  ...
  it("LINE 204 - Tasker accept task SofaCleaning have newCostDetail and not enough money", async () => {
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "TH", financialAccountData: { TH_FMainAccount: 10000, TH_Promotion: 10000 } })
  ...
  it("LINE 262 - Tasker accept task SofaCleaning have newCostDetail", async () => {
    const ref = await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
    ...
    await initData("update-user/financialAccount", {
      phone: "0834567895",
      isoCode: "TH",
      financialAccountData: { TH_FMainAccount: 500000, TH_Promotion: 50000 },
    });
    await initData("th/updateTask", {
      taskId: ref.taskId,
      dataUpdate: {
  ...
  // SofaCleaning have subscriptionId
  it("LINE 321 - Tasker accept task SofaCleaning have newCostDetail", async () => {
    const ref = await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
