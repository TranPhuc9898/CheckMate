 ...
 * @desc [Tasker cancel task SofaCleaning thailand]
...
describe("FILE: thailand/flow-test/service-sofa-cleaning/cancel-task-sofa-cleaning.spec.js - Tasker cancel task SofaCleaning th", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567895", isoCode: "TH", fields: ["taskCancelByTasker"] });
  });

  //  Tasker thấy Huỷ việc
  it("LINE 40 - Tasker cancel task SofaCleaning not have reason NEARBY_TASK_PLACE", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
      description: "My Task",
      acceptedTasker: "0834567895",
    });
  ...
  it("LINE 174 - Tasker cancel task SofaCleaning and fee 20k", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
