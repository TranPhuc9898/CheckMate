...
describe("FILE: thailand/flow-test/qr-task.spec.js - Tasker see the QR code", () => {
  beforeEach(async () => {
  ...
  it("LINE 25 - Tasker see the QR code when task have status === CONFIRMED", async () => {
  ...
  it("LINE 49 - If task dont have status !== CONFIRMED ", async () => {
    await initData("th/task/createTask", {
      resetCollection: true,
      serviceName: "CLEANING",
      viewedTaskers: ["0834567891"],
