...
describe("FILE: flow-test/password/forgot-password.spec.js - Forgot password and take it again", () => {
  beforeEach(async () => {
  ...
  // test suggest
  it("LINE 14 - Tasker forgot password", async () => {
    ...
    await fillActiveCode("0834567891", "+66");
