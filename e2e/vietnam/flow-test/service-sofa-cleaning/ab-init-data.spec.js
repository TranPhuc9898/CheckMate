...
describe("FILE: vietnam/flow-test/service-sofa-cleaning/ab-init-data.spec.js - Init data before run test", () => {
  beforeEach(async () => {
  ...
  it("LINE 19 - Reset data", async () => {
    ...
    await loginWithPhoneAndPassword("0834567895", "123456", "VN");
  });
