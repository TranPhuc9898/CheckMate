 ...
 * @desc [Tasker cancel task SofaCleaning vietnam]
...
describe("FILE: vietnam/flow-test/service-sofa-cleaning/cancel-task-sofa-cleaning.spec.js - Tasker cancel task SofaCleaning vn", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567895", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });
