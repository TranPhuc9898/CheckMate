...
describe("FILE: vietnam/flow-test/service-sofa-cleaning/accept-task-sofa-cleaning.spec.js - Tasker accept task SofaCleaning vn", () => {
  beforeEach(async () => {
    ...
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "VN", financialAccountData: { FMainAccount: 100000, Promotion: 100000 } })
  });
  ...
  // Thấy công việc và nhận công việc
  it("LINE 131 - Tasker accept task SofaCleaning vn", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "SofaCleaning",
      viewedTaskers: ["0834567895"],
  ...
  it("LINE 186 - Tasker accept task SofaCleaning not enough money", async () => {
    ...
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "VN", financialAccountData: { FMainAccount: 10, Promotion: 10 } })
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskSofaCleaning", 1000);
    await tapId("newTask_My TaskSofaCleaning");
    await swipe("scrollTaskDetail", "up");
  ...
  it("LINE 204 - Tasker accept task SofaCleaning have newCostDetail and not enough money", async () => {
    await initData('update-user/financialAccount', { phone: "0834567895", isoCode: "VN", financialAccountData: { FMainAccount: 10000, Promotion: 10000 } })
