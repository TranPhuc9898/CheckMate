...
describe('FILE: vietnam/flow-test/service-elderly-care/done-task-elderly-care.spec.js - Tasker done task Viet Nam', () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData('update-user/financialAccount', { phone: "0834567894", isoCode: "VN", financialAccountData: { FMainAccount: 100000, Promotion: 30000 } })
    await initData('vn/update-user/remove-transaction', { phone: "0834567894" });
  });
