 ...
 * @desc [Tasker cancel task ELDERLY_CARE vietnam]
...
describe("FILE: vietnam/flow-test/service-elderly-care/cancel-task-elderly-care.spec.js - Tasker cancel task ELDERLY_CARE vn", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567894", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });

  //  Tasker thấy Huỷ việc
  it("LINE 40 - Tasker cancel task ELDERLY_CARE not have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My Task",
      acceptedTasker: "0834567894",
    });
  ...
  // Tasker  thấy huỷ việc và chọn huỷ với lý do NEARBY_TASK_PLACE nhưng không thành công
  it("LINE 65 - Tasker cancel task ELDERLY have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
  ...
  it("LINE 149 - Tasker cancel task Elderly Care and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
  ...
  it("LINE 174 - Tasker cancel task ELDERLY_CARE and fee 20k", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
  ...
  it("LINE 198 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
  ...
  it("LINE 222 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
  ...
  it("LINE 363 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
