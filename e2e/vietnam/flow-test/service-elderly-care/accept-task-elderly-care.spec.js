...
describe("FILE: vietnam/flow-test/service-elderly-care/accept-task-elderly-care.spec.js - Tasker accept task ELDERLY CARE vn", () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData('update-user/financialAccount', { phone: "0834567894", isoCode: "VN", financialAccountData: { FMainAccount: 100000, Promotion: 100000 } })
  });
  ...
  it("LINE 38 - When the filter button is pressed, Tasker creates a lot of tasks, and the job is displayed at the top.", async () => {
    await initData("vn/task/createTask", {
      ...
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE2",
      date: moment().add(2, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE3",
      date: moment().add(3, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE4",
      date: moment().add(4, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE5",
      date: moment().add(5, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE6",
  ...
  // Thấy công việc và nhận công việc
  it("LINE 131 - Tasker accept task ELDERLY_CARE vn", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
      description: "My TaskELDERLY_CARE",
    });
    await device.reloadReactNative();
    await tapId("newTask_My TaskELDERLY_CARE");
    ...
    // await tapText("Đóng");
    await tapHeaderBack();
    await tapId("confirmTask_My TaskELDERLY_CARE");
    await swipe("scrollTaskDetail", "up");
  ...
  // conflict time
  it("LINE 153 - Tasker accept task cleaning dont see task conflict time", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "ELDERLY_CARE",
      viewedTaskers: ["0834567894"],
    ...
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskELDERLY_CARE", 1000);
    await tapId("newTask_My TaskELDERLY_CARE");
    await swipe("scrollTaskDetail", "up");
    await swipe("swipeBtn", "right");
    await tapHeaderBack();
    ...
    await expectElementNotExist("newTask_My TaskELDERLY_CARE");
  });
  // Không đủ tiền
  it("LINE 184 - Tasker accept task cleaning not enough money", async () => {
    ...
    await initData('update-user/financialAccount', { phone: "0834567894", isoCode: "VN", financialAccountData: { FMainAccount: 10, Promotion: 10 } })
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskELDERLY_CARE", 1000);
    await tapId("newTask_My TaskELDERLY_CARE");
    await swipe("scrollTaskDetail", "up");
  ...
  it("LINE 202 - Tasker accept task have newCostDetail and not enough money", async () => {

    await initData('update-user/financialAccount', { phone: "0834567894", isoCode: "VN", financialAccountData: { FMainAccount: 10000, Promotion: 10000 } })
