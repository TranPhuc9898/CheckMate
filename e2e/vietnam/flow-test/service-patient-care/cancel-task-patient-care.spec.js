 ...
 * @desc [Tasker cancel task PATIENT_CARE vietnam]
...
describe("FILE: vietnam/flow-test/service-patient-care/cancel-task-patient-care.spec.js - Tasker cancel task patient care vn", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567898", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });

  //  Tasker thấy Huỷ việc
  it("LINE 38 - Tasker cancel task not have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "PATIENT_CARE",
      viewedTaskers: ["0834567898"],
      description: "My Task",
      acceptedTasker: "0834567898",
    });
  ...
  it("LINE 65 - Tasker cancel task PATIENT_CARE have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "PATIENT_CARE",
      viewedTaskers: ["0834567898"],
  ...
  it("LINE 149 - Tasker cancel task Patient Care and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "PATIENT_CARE",
      viewedTaskers: ["0834567898"],
