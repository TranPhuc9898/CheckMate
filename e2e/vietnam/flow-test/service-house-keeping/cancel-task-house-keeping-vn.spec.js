 ...
 * @desc [Tasker cancel task HOUSE_KEEPING vietnam]
...
describe("FILE: vietnam/flow-test/service-house-keeping/cancel-task-service-house-keeping.spec.js - Tasker cancel task HOUSE_KEEPING vn", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567897", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });
  ...
  it("LINE 65 - Tasker cancel task HOUSE_KEEPING have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOUSE_KEEPING",
      viewedTaskers: ["0834567897"],
  ...
  it("LINE 149 - Tasker cancel task House Keeping and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOUSE_KEEPING",
      viewedTaskers: ["0834567897"],
  ...
  it("LINE 174 - Tasker cancel task HOUSE_KEEPING and fee 20k", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOUSE_KEEPING",
      viewedTaskers: ["0834567897"],
