...
describe("FILE: vietnam/flow-test/service-home-cooking/ab-init-data.spec.js - Init data before run test", () => {
  beforeEach(async () => {
  ...
  it("LINE 19 - Reset data", async () => {
    ...
    await loginWithPhoneAndPassword("0834567896", "123456", "VN");
  });
