 ...
 * @desc [Tasker cancel task HOME_COOKING vietnam]
...
describe("FILE: vietnam/flow-test/service-home-cooking/cancel-task-home-cooking.spec.js - Tasker cancel task HOME_COOKING vn", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567896", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });

  //  Tasker thấy Huỷ việc
  it("LINE 40 - Tasker cancel task HOME_COOKING not have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOME_COOKING",
      viewedTaskers: ["0834567896"],
      description: "My Task",
      acceptedTasker: "0834567896",
    });
    ...
    await waitForElement("Số người ăn: ", 1000, "text");
    await waitForElement("Giờ ăn: ", 1000, "text");
    await waitForElement("Tiền đi chợ: ", 1000, "text");
  ...
  it("LINE 67 - Tasker cancel task have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOME_COOKING",
      viewedTaskers: ["0834567896"],
  ...
  it("LINE 151 - Tasker cancel task Home Cooking and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOME_COOKING",
      viewedTaskers: ["0834567896"],
  ...
  it("LINE 175 - Tasker cancel task HOME_COOKING and fee 20k", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "HOME_COOKING",
      viewedTaskers: ["0834567896"],
