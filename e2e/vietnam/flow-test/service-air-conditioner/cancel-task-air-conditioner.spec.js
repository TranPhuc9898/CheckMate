...
describe("FILE: vietnam/flow-test/service-air-conditioner/cancel-task-air-conditioner.spec.js - Tasker cancel task air conditioner Viet Nam", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567892", isoCode: "VN", fields: ["taskCancelByTasker"] });
