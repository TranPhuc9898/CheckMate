...
describe("FILE: vietnam/flow-test/service-air-conditioner/accept-task-air-conditioner.spec.js - Tasker accept task air conditioner Viet Nam", () => {
  beforeEach(async () => {
  ...
  // Thấy công việc và nhận công việc
  it("LINE 206 - Tasker accept task air conditioner vn", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "AIR_CONDITIONER_SERVICE",
      viewedTaskers: ["0834567892"],
