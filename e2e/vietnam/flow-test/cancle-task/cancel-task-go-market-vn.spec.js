 ...
 * @desc [Tasker cancel task GO_MARKET vietnam]
...
describe("FILE: vietnam/flow-test/cancel-task/tasker-cancel-task-GO_MARKET-vn.spec.js - Tasker cancel task GO_MARKET vn", () => {
  beforeEach(async () => {
  ...
  it("LINE 40 - Tasker cancel task GO_MARKET not have reason NEARBY_TASK_PLACE", async () => {
  ...
  it("LINE 149 - Tasker cancel task Go Market and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "GO_MARKET",
      viewedTaskers: ["0834567891"],
  ...
  it("LINE 174 - Tasker cancel task GO_MARKET and fee 20k", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "GO_MARKET",
      viewedTaskers: ["0834567891"],
