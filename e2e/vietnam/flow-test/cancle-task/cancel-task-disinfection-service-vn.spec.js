 ...
 * @desc [Tasker cancel task DISINFECTION_SERVICE vietnam]
...
describe("FILE: vietnam/flow-test/cancel-task/tasker-cancel-task-DISINFECTION_SERVICE-vn.spec.js - Tasker cancel task DISINFECTION_SERVICE vn", () => {
  beforeEach(async () => {
  ...
  it("LINE 40 - Tasker cancel task DISINFECTION not have reason NEARBY_TASK_PLACE", async () => {
  ...
  // Tasker  thấy huỷ việc và chọn huỷ với lý do NEARBY_TASK_PLACE nhưng không được vì không đứng gần chỗ làm
  it("LINE 65 - Tasker cancel task DISINFECTION have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "DISINFECTION_SERVICE",
      viewedTaskers: ["0834567891"],
  ...
  it("LINE 150 - Tasker cancel task DISINFECTION and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "DISINFECTION_SERVICE",
      viewedTaskers: ["0834567891"],
  ...
  it("LINE 176 - Tasker cancel task DISINFECTION_SERVICE and fee 20k", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "DISINFECTION_SERVICE",
      viewedTaskers: ["0834567891"],
