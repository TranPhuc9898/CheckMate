 ...
 * @desc [Tasker cancel task CHILD_CARE vietnam]
...
describe("FILE: vietnam/flow-test/service-child-care/cancel-task-child-care.spec.js - Tasker cancel task child-care vn", () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData("update-user/unset-fields", { phone: "0834567893", isoCode: "VN", fields: ["taskCancelByTasker"] });
  });

  //  Tasker thấy Huỷ việc
  it("LINE 40 - Tasker cancel task not have reason NEARBY_TASK_PLACE", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My Task",
      acceptedTasker: "0834567893",
    });
  ...
  it("LINE 150 - Tasker cancel task CHILD_CARE and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
  ...
  it("LINE 174 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
  ...
  it("LINE 202 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
  ...
  it("LINE 227 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
  ...
  it("LINE 358 - Tasker cancel task and status task change to CANCELED", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
