...
describe("FILE: vietnam/flow-test/service-child-care/accept-task-child-care.spec.js - Tasker accept task child care vn", () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData('update-user/financialAccount', { phone: "0834567893", isoCode: "VN", financialAccountData: { FMainAccount: 100000, Promotion: 100000 } })
  });
  ...
  it("LINE 37 - When the filter button is pressed, Tasker creates a lot of tasks, and the job is displayed at the top.", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE2",
      date: moment().add(2, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE3",
      date: moment().add(3, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE4",
      date: moment().add(4, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE5",
      date: moment().add(5, "d").toDate()
    });
    await initData("vn/task/createTask", {
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE6",
  ...
  // Thấy công việc và nhận công việc
  it("LINE 131 - Tasker accept task Child Care vn", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
      description: "My TaskCHILD_CARE",
    });
    await device.reloadReactNative();
    await tapId("newTask_My TaskCHILD_CARE");
    ...
    // await tapText("Đóng");
    await tapHeaderBack();
    await tapId("confirmTask_My TaskCHILD_CARE");
    await swipe("scrollTaskDetail", "up");
  ...
  // conflict time
  it("LINE 153 - Tasker accept task Child Care dont see task conflict time", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
    ...
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskCHILD_CARE", 1000);
    await tapId("newTask_My TaskCHILD_CARE");
    await swipe("scrollTaskDetail", "up");
    await swipe("swipeBtn", "right");
    await tapHeaderBack();
    ...
    await expectElementNotExist("newTask_My TaskCHILD_CARE");
  });
  // Không đủ tiền
  it("LINE 184 - Tasker accept task cleaning not enough money", async () => {
    await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
    ...
    await initData('update-user/financialAccount', { phone: "0834567893", isoCode: "VN", financialAccountData: { FMainAccount: 10, Promotion: 10 } })
    await device.reloadReactNative();
    await waitForElement("newTask_My TaskCHILD_CARE", 1000);
    await tapId("newTask_My TaskCHILD_CARE");
    await swipe("scrollTaskDetail", "up");
  ...
  it("LINE 202 - Tasker accept task Child Care have newCostDetail and not enough money", async () => {

    await initData('update-user/financialAccount', { phone: "0834567893", isoCode: "VN", financialAccountData: { FMainAccount: 10000, Promotion: 10000 } })
  ...
  it("LINE 261 - Tasker accept task Child Care have newCostDetail", async () => {
    const ref = await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
      viewedTaskers: ["0834567893"],
  ...
  // CHILD_CARE have subscriptionId
  it("LINE 261 - Tasker accept task Child Care have newCostDetail", async () => {
    const ref = await initData("vn/task/createTask", {
      resetCollection: true,
      serviceName: "CHILD_CARE",
