...
describe("FILE: vietnam/flow-test/car-advertising/tasker-of-car-advertising-see-referral-code.spec.js - Tasker of car advertising see referral code", () => {
  beforeEach(async () => {
  ...
  it("LINE 26 - Tasker accept task auto confirm and navigate to Chat", async () => {
    ...
    await expectElementVisible("txtNumberCustomerDoneTask");
    await initData("serviceChannel/update-serviceChannel", {
      type: "Remove",
      serviceName: "CAR_ADVERTISING",
      phone: "0834567891"
