...
describe('FILE: indonesia/flow-test/accept-task/accept-task-cleaing-indo.spec.js - Tasker accept tassk cleaing indo', () => {
  beforeEach(async () => {
    await device.launchApp();
    await initData('user/createUser', { phone: '0834567899', isoCode: 'ID', idNumber: "123456799", status: "UNVERIFIED", resetUser: true });
    await initData('training/resetData', {});
