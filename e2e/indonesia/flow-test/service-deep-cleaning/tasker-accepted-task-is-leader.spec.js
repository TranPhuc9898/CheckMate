...
describe("FILE: indonesia/flow-test/service-deep-cleaning/tasker-accepted-task-is-leader.spec.js - Tasker accept task deep cleaning id", () => {
  beforeEach(async () => {
  ...
  it("LINE 85 - Payment method is CASH", async () => {
    ...
    await expectElementVisible("1,000,000Rp", "text");
    await scroll("scrollTaskDetail", 300, "down");
    await expectElementVisible("Chuyển khoản: 500,000Rp", "text");
  });
  ...
  it("LINE 102 - Payment method is CASH have promotion", async () => {
    ...
    await tapId("confirmTask_My Task");
    await expectElementVisible("Thu tiền mặt", "text");
    await expectElementVisible("800,000Rp", "text");
    await expectElementVisible("+200,000Rp Sẽ được chia đều và thêm vào tài khoản khuyến mãi của các thành viên.", "text");
    await scroll("scrollTaskDetail", 300, "down");
    await expectElementVisible("Chuyển khoản: 400,000Rp", "text");
    await expectElementVisible("Khuyến mãi: 100,000Rp", "text");
  });
  ...
  it("LINE 244 - Payment method is prepayment method and new cost", async () => {
    ...
    await expectElementVisible("Chuyển khoản", "text");
    await expectElementVisible("1,000,000Rp", "text");
    await expectElementVisible("+200,000Rp Thu tiền mặt từ khách hàng", "text");
    await scroll("scrollTaskDetail", 300, "down");
    await expectElementVisible("Chuyển khoản: 500,000Rp", "text");
    await expectElementVisible("Tiền mặt: 100,000Rp", "text");
    await expectElementVisible("Nhận thêm từ bạn: 100,000Rp", "text");
  });
