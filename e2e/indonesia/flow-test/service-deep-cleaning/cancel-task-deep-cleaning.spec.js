 ...
 * @desc [Tasker cancel task DEEP_CLEANING indonesia]
...
describe("FILE: indonesia/flow-test/cancel-task/tasker-cancel-task-DEEP_CLEANING-id.spec.js - Tasker cancel task DEEP_CLEANING id", () => {
  beforeEach(async () => {
    ...
    await initData("update-user/unset-fields", { phone: "0834567899", isoCode: "ID", fields: ["taskCancelByTasker"] });
  });

  //  Tasker Không huỷ được task deep cleaning
  it("LINE 35 - Tasker cant cancel task deep cleaning", async () => {
