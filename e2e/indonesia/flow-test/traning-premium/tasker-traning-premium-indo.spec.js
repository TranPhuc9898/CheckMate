...
describe('FILE: indonesia/flow-test/tasker-traning/tasker-traning-premium-indo.spec.js - Tasker traning premium', () => {
  beforeEach(async () => {
    ...
    await initData('/quizForTaskerPremium/update', {
      isAdd: true,
    ...
    await initData('/quizForTaskerPremiumHistory/update', { isRemove: true });
