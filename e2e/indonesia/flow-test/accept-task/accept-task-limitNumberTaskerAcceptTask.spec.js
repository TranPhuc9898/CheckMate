...
describe("FILE: indonesia/flow-test/accept-task/limit-number-tasker-accept-task.spec.js - Tasker locked", () => {
  beforeEach(async () => {
    ...
    await initData('update-user/financialAccount', { phone: "0834567891", isoCode: "ID", financialAccountData: { ID_FMainAccount: 300000, ID_Promotion: 2000 } })
    await initData('id/update/settingSystem', {
      limitNumberTaskerAcceptTask: 10,
    });
  });

  it("LINE 42 - Tasker ID accept task limitNumberTaskerAcceptTask", async () => {
  ...
  it("LINE 149 - FAV Tasker ID accept task limitNumberTaskerAcceptTask", async () => {
