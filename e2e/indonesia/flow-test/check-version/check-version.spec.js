...
describe("FILE: check-version/check-version.spec.js - Tasker have old version, which mean the need to update", () => {
  ...
  // Test Case 1
  it("LINE 29 - App Tasker old 0.9.0 dont show anything", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "0.9.0",
  ...
  it("LINE 60 - version 2.0.0, isForce = false -> hiện alert có phiên bản mới", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "2.2.0",
  ...
  it("LINE 88 - Tasker have old version need to update now", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "1.9.0",
  ...
  it("LINE 112 - version 0.9.0 show maintain screen ", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "0.9.0",
  ...
  it("LINE 136 - isMaintain = true isForce = false version 2.0.0 show maintain screen ", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "2.1.0",
  ...
  it("LINE 162 - isMaintain = true isForce = true version 2.0.0 show maintain screen ", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "2.1.0",
  ...
  it("LINE 190 - isAllSystem = false isForce = true version 2.0.0 show newVersion screen ", async () => {
    await initData('id/update/settingSystem', {
      versionApp: {
        "ios": {
          "version": "2.1.0",
