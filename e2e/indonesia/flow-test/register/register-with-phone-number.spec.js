...
describe('FILE: vietnam/flow-test/register/register-with-phone-number.spec.js - Register with phone number', () => {
  ...
  it('LINE 36 - Tasker register with phone number', async () => {
    ...
    await fillActiveCode('0834567810', "+62");
  });

  it('LINE 52 - Tasker register with ID number exist', async () => {
    await initData("user/deleteUser", {phone: "0834567899"});
    await initData('/user/createUser', {resetUser: true, phone: '0834567899', isoCode: 'ID', idNumber: "123456789"});
    await tapId('btnNextToRegister');
    await typeToTextField('nameInput', 'Tasker Test');
  ...
  it('LINE 69 - Tasker register with TH number exist', async () => {
    await initData('/user/createUser', {resetUser: true, phone: '0834567899', isoCode: 'ID', idNumber: "123456789"});
  ...
  it('LINE 85 - Tasker register with Referral code not exist', async () => {
    await expectElementVisible("btnNextToRegister",2000);
    await tapId('btnNextToRegister');
    await typeToTextField('nameInput', 'Tasker Test');
    await tapId('idNumberInput');
  ...
  it('LINE 101 - Tasker login', async () => {
